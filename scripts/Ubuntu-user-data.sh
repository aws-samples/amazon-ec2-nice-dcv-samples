...
apt-get install -q -y python3-setuptools wget tmux unzip tar curl sed
...
apt-get install -q -y pulseaudio-utils gnome-tweaks gnome-shell-extension-ubuntu-dock
