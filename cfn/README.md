...
- `sessionType` (Linux only): `virtual` or `console` [NICE DCV sessions](https://docs.aws.amazon.com/dcv/latest/adminguide/managing-sessions.html#managing-sessions-intro). Default is `virtual`. NVIDIA Grid and NVIDIA Gaming driver installation may be available as `console_NVIDIA_GRID_Driver` and `console_NVIDIA_Gaming_Driver` for [G4dn](https://aws.amazon.com/ec2/instance-types/g4/) and [G5](https://aws.amazon.com/ec2/instance-types/g5/) instance types.
