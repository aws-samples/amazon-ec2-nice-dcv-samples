...
For Ubuntu, you can select `console-with-Ubuntu_repo_Driver` option to install latest NVIDIA [Enterprise Ready Drivers (ERD)](https://ubuntu.com/server/docs/nvidia-drivers-installation).
