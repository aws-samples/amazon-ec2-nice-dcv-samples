...
- `sessionType` (Linux) : `virtual` (default) or `console` [session type](#console-and-virtual-sessions). [GPU driver installation](#gpu-linux-instances) option may be available for some Linux OSs
