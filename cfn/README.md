...
- `EC2instanceConnect` (Linux only): [in-browser SSH](https://aws.amazon.com/blogs/compute/new-using-amazon-ec2-instance-connect-for-ssh-access-to-your-ec2-instances/) URL link. Feature requires your security group to allow inbound SSH from [EC2_INSTANCE_CONNECT](https://github.com/aws-samples/ec2-lamp-server#ec2-instance-connect-ip-prefixes) IP address range and [may not be work](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-connect-prerequisites.html).
